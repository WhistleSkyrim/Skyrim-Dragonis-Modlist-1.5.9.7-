...
2. **Фризы?**  
   ...
   - Отключи TexGen_Output и DynDOLOD_Output (уменьшит качество, но улучшит стабильность)  
...
9. **Почему графика хуже, чем на видео?**  
   ➤ На видео приватный ENB, доступен только на Boosty  
