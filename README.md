...
- 😮‍💨 Нет излишней духоты. Геймплей рассчитан на обычного среднестатистического игрока, который заходит в игрц расслабиться. Если ты ищешь интересный и не душный геймплей то ты попал по адресу
- 💯 Графика, лучше которой вы не найдёте. Над её созданием я очень сильно запарился. 
...
5. **MO2 не видит SKSE?**  
   ➤ Переустанови [SKSE](https://skse.silverlock.org/beta/skse64_2_02_06.7z) — положи skse.exe в `SkyrimDragonis/mods/SKSE/Root/`  

8. **Как поменять разрешение? Ничего не получается**      
...
1. **Поддержка геймпадов?**  
   ➤ Есть, включи её внизу мод органайзера в разделителе под названием "Поддержка геймпада" 

2. **Как узнать все бинды?**  
   ➤ Нажми **F11** в игре  

3. **Кнопка переката (доджа)**  
   ➤ **Кнопка спринта** (работает только с оружием в руках)  
...
<details>
<summary><strong>⚔️ Геймплей (что за что отвечает)</strong></summary>

- **🩸 Sacrilege — Minimalistic Vampires of Skyrim**  
  ➤ Полная переработка вампиров: способности, баланс, прогрессия.

- **🐺 Growl – Werebeasts of Skyrim**  
  ➤ Обновлённые механики вервольфов: перки, трансформации, улучшенные способности.

- **⚔️ Wildcat – Combat of Skyrim**  
  ➤ Основная боевая система: динамичные сражения, изменённый урон, выносливость и ИИ врагов.

- **🥋 MCO + Stances**  
  ➤ Модернизированная боёвка: плавные анимации, стойки оружия, новые комбо и боевые приёмы.

- **📘 Vokrii – Minimalistic Perks of Skyrim**  
  ➤ Полный ребаланс перков с более логичной и вариативной прогрессией.

- **📜 Квестовые моды**  
  ➤ Крупные сюжетные дополнения:  
    • *Legacy of the Dragonborn - Музей Драконорожденного*  
    • *Wyrmstooth - Клык Вирма*  
    • *UNSLAAD - УНСЛААД*
    • *The Forgotten City - Забытый город*
    • *Carved Brink - Резной Край*
    • *Sirenroot - Корень Сирены*
  
  ➤ Плюс множество мелких квестов, расширяющих мир и дополняющих лор.

---

### 💥 Множители урона

➤ Значения сложности влияют на урон, который наносят игрок и враги:      
...
8. **Как начать ванильный старт?**       
   ➤ Отправляйте в Хелген, снимите там комнату и поспите в ней.

9. **Что делать если пишет вот это?**
    <img width="817" height="381" alt="изображение" src="https://github.com/user-attachments/assets/81d39a83-2d55-4642-8403-191c063815d0" />


   ➤ Если не получается поговорить с Матларой (нет диалога и она говорит только базовые фразы) значит что сейв поломан. К сожалению это проблема мода на альтернативный старт.          
</details>
